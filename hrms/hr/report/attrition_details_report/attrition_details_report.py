...
def get_attrition(filters):
    ...
    for att in attrition:
        ...
        row = [att.employee,att.employee_name,att.department,att.employment_type,att.employee_category,att.destination,att.relieving_date]
