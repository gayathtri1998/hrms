...
def get_columns(filters):
    columns = []
    columns += [
        _("Employee ID") + ":Data/:150",_("Employee Name") + ":Data/:200",_("Department") + ":Data/:150",_("OT From Date") + ":Data/:150",_("OT To Date") + ":Data/:150",_("Shift") + ":Link/:100",_("OT Hours") + ":Data/:150",_("OT Starting Time") + ":Time/:150",_("Document Status") + ":Data/:200"
    ]
    return columns
